...
- (void)userLogin:(CDVInvokedUrlCommand *)command {
  ...
  NSLog(@"username %@",user);
  if (user[@"username"] && user[@"password"]) {
    [JMSGUser loginWithUsername:user[@"username"] password:user[@"password"] completionHandler:^(id resultObject, NSError *error) {//user
      if (!error) {
        [self handleResultWithDictionary:@{} command:command error: nil];
      } else {
        [self handleResultWithDictionary:nil command:command error: error];
...
- (void)sendInvitationRequest:(CDVInvokedUrlCommand *)command {
  ...
  [JMSGFriendManager sendInvitationRequestWithUsername:param[@"username"] appKey:appKey reason: param[@"reason"] completionHandler:^(id resultObject, NSError *error) {
    if (error) {
      [self handleResultWithDictionary: nil command: command error:error];
      return ;
    }
...
- (void)acceptInvitation:(CDVInvokedUrlCommand *)command {
  ...
  [JMSGFriendManager acceptInvitationWithUsername:param[@"username"] appKey:appKey completionHandler:^(id resultObject, NSError *error) {
    if (error) {
      [self handleResultWithDictionary: nil command: command error:error];
      return ;
    }
...
- (void)declineInvitation:(CDVInvokedUrlCommand *)command {
  ...
  [JMSGFriendManager rejectInvitationWithUsername:param[@"username"] appKey:appKey reason:param[@"reason"] completionHandler:^(id resultObject, NSError *error) {
    if (error) {
      [self handleResultWithDictionary: nil command: command error:error];
      return ;
    }
...
- (void)setNoDisturbGlobal:(CDVInvokedUrlCommand *)command {
  ...
  [JMessage setIsGlobalNoDisturb:param[@"isNoDisturb"] handler:^(id resultObject, NSError *error) {
    [self handleResultWithDictionary:nil command:command error:error];
  }];
  ...
  if ([param[@"type"] isEqual: @"single"]) {
    [JMSGConversation createSingleConversationWithUsername:param[@"username"] appKey:appKey completionHandler:^(id resultObject, NSError *error) {
      ...
      if (message.contentType != kJMSGContentTypeImage) {
        ...
        JMSGImageContent *content = message.content;
  ...
  if ([param[@"type"] isEqual: @"single"]) {
    [JMSGConversation createSingleConversationWithUsername:param[@"username"] appKey:appKey completionHandler:^(id resultObject, NSError *error) {
      ...
      if (message.contentType != kJMSGContentTypeVoice) {
        ...
        JMSGVoiceContent *content = message.content;
  ...
  if ([param[@"type"] isEqual: @"single"]) {
    [JMSGConversation createSingleConversationWithUsername:param[@"username"] appKey:appKey completionHandler:^(id resultObject, NSError *error) {
      ...
      if (message.contentType != kJMSGContentTypeFile) {
        ...
        JMSGFileContent *content = message.content;
